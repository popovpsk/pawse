...
pub static JA: Strings = lang! {
    ...
    lastfm_status_awaiting: "ブラウザで pawse を承認してから確認してください。",
    ...
    scrobble_auth_restart: "もう一度開く",
    scrobble_auth_pending: "まだ承認されていません。ブラウザのページで pawse を許可してから「確認」を押してください。ページを閉じた場合は「もう一度開く」を押してください。",
    scrobble_auth_link_expired: "認証リンクは無効になりました。「もう一度開く」を押して新しいリンクを取得してください。",
