...
pub static JA: Strings = lang! {
    ...
    subsonic_servers: "サーバー",
    subsonic_servers_desc: "Navidrome、Gonic、Airsonic などの Subsonic 互換サーバー。ローカルフォルダーにもある曲は 1 回だけ表示されます。",
    subsonic_url: "サーバーのアドレス",
    subsonic_username: "ユーザー名",
    subsonic_password: "パスワード",
    subsonic_connect: "接続",
    subsonic_sync: "同期",
    subsonic_import_stars: "お気に入りをインポート",
    network_cache: "ネットワークキャッシュ",
    network_cache_desc: "再生用に保存されたネットワークソースの曲。",
    cache_used: "使用中",
    cache_clear: "消去",
    cache_limit: "上限",
    ...
    size_mb_t: "{} MB",
    size_gb_t: "{} GB",
    subsonic_auth_failed: "ユーザー名またはパスワードが違います",
    subsonic_unreachable_t: "サーバーに接続できません: {}",
    subsonic_fill_fields: "アドレスとユーザー名を入力してください",
