...
pub static JA: Strings = lang! {
    ...
    subsonic_servers_desc: "Navidrome、Gonic、Airsonic などの Subsonic 互換サーバー。",
    ...
    album_to_local: "ローカルライブラリへ移動",
    album_to_local_progress_t: "移動中: {} / {} · クリックで停止",
    album_to_local_done_t: "アルバムを {} に移動しました",
    album_to_local_failed_t: "一部を移動できませんでした: {}",
    album_to_local_pick_title: "アルバムの移動先",
    cache_used: "使用中",
    cache_clear: "消去",
    cache_limit: "上限",
    ...
    torrent_upload_desc: "Pawse はトレントからダウンロード中とその後 15 分間だけ共有します。",
