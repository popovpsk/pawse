...
pub static JA: Strings = lang! {
    ...
    local_folders: "ローカルフォルダー",
    server_list: "サーバー",
    subsonic_servers_desc: "Navidrome、Gonic、Airsonic などの Subsonic 互換サーバー。ローカルフォルダーにもある曲は 1 回だけ表示されます。",
    jellyfin_servers_desc: "Jellyfin サーバー。サインインは一度だけ — Pawse はパスワードではなくアクセストークンを保存します。ローカルにもある曲は一度だけ表示されます。",
    server_url: "サーバーのアドレス",
    server_username: "ユーザー名",
    server_password: "パスワード",
    server_connect: "接続",
    server_sync: "同期",
    server_import_favorites: "お気に入りをインポート",
    network_cache: "ネットワークキャッシュ",
    network_cache_desc: "ネットワークの音楽はディスクに保存されます。一度再生したトラックはダウンロードせずにすぐ始まり、オフラインでも再生できます。",
    cache_fill: "キャッシュに保存",
    cache_fill_progress_t: "{} / {} 件保存済み · クリックで停止",
    cache_fill_too_big_title: "すべてはキャッシュに入りません",
    cache_fill_too_big_t: "{} 必要ですが、キャッシュの上限は {} です。最初の {} 件のファイルだけを保存します（全 {} 件）。",
    cache_fill_part: "入る分だけ保存",
    cache_used: "使用中",
    cache_clear: "消去",
    cache_limit: "上限",
    cache_limit_desc: "上限を超えると古い曲から削除されます。",
    cache_unlimited: "無制限",
    decimal_separator: ".",
    size_mb_t: "{} MB",
    size_gb_t: "{} GB",
    ...
    no_servers_added: "サーバーは追加されていません",
    torrents: "トレント",
    torrent_list: "ソース",
    torrents_desc: "BitTorrent で共有されたアルバム。Pawse はライブラリ用にタグとカバーだけをダウンロードし、再生時にトラックを取得します。",
    torrent_magnet: "マグネットリンク",
    torrent_add: "追加",
    torrent_choose_file: ".torrent ファイルを選択…",
    torrent_invalid: "マグネットリンクでも .torrent ファイルでもありません",
    no_torrents_added: "トレントはありません",
    torrent_upload: "アップロード",
    torrent_upload_desc: "共有するとダウンロードが速くなります。Pawse はトレントからダウンロード中とその後 15 分間だけ共有します。",
    torrent_upload_while_active: "ダウンロード中",
    torrent_upload_limited: "最大 128 KB/s",
    torrent_upload_off: "オフ",
    torrent_peers_t: "ピア: {}/{}",
    server_online: "利用可能",
    server_offline: "利用不可",
    source_syncing: "同期中…",
    ...
    source_online: "利用可能",
    source_offline: "利用不可",
    source_scanning: "スキャン中…",
    unavailable_count_t: "利用不可: {}",
    no_music_sources: "まだ音楽が追加されていません。",
    open_library_settings: "ライブラリの設定",
    ...
    settings_now_playing: "再生中",
    now_playing_details: "3行目",
    now_playing_details_desc: "曲名とアーティストの下に表示する内容",
    now_playing_details_specs: "フォーマット",
    now_playing_details_album: "アルバム",
    font_size: "フォントサイズ",
    font_size_desc: "アプリ全体で使われる文字サイズ",
    font_size_small: "小",
    font_size_medium: "中",
    font_size_large: "大",
    blur_background: "背景をぼかす",
    blur_background_desc: "ぼかしたカバーアートを背景に使います",
    blur_background_off: "オフ",
    blur_background_cover: "カバー表示",
    blur_background_all: "すべての画面",
    blur_intensity: "ぼかしの強さ",
    blur_intensity_desc: "背景がどれだけぼやけているか",
    blur_interface_opacity: "インターフェースの不透明度",
    blur_interface_opacity_desc: "ぼかしの上でインターフェースがどれだけ透けているか",
    liked_tracks: "お気に入り",
    ...
    settings_albums_view: "アルバム表示",
    albums_layout: "レイアウト",
    albums_layout_desc: "アルバムタブでのアルバムの表示方法",
    albums_layout_list: "リスト",
    albums_layout_grid: "グリッド",
    year_column: "年の列",
    year_column_desc: "アルバム一覧に年の列を表示",
    album_year: "年",
    album_year_desc: "タイルの説明に年を表示",
    genre_column: "ジャンルの列",
    genre_column_desc: "アルバム一覧にジャンルの列を表示",
    albums_artist_desc: "リストでアルバムアーティストを表示する方法",
    ...
    native_rate_title: "ネイティブサンプルレート",
    ...
    lastfm_status_connected: "接続済み",
    lastfm_sign_in: "サインイン",
    lastfm_sign_out: "サインアウト",
    lastfm_unavailable: "このビルドでは Last.fm が設定されていません。",
    settings_scrobbling: "Scrobble",
    scrobble_account: "アカウント",
    scrobble_enabled: "有効",
    scrobble_send_loves: "お気に入りを送信",
    scrobble_send_loves_desc: "ここでの「好き」はサービス側のお気に入りにも追加します。解除するとあちらからも削除されます。",
    scrobble_file: "ファイル",
    scrobble_first_artist: "最初のアーティストのみ Scrobble",
    scrobble_first_artist_desc: "すべての演奏者を連結せず、1曲につき1人のアーティスト名を送信します。",
    scrobble_csv: "CSVログ",
    scrobble_csv_desc: "すべての Scrobble をローカルの CSV ファイルに追記します。",
    scrobble_file_open: "開く…",
    scrobble_file_new: "新規…",
    scrobble_not_a_log: "このファイルは pawse のスクロブルログではありません。",
    scrobble_token: "トークン",
    scrobble_server: "サーバー",
    scrobble_connect: "接続",
    scrobble_auth_expired: "認証の有効期限が切れました。再度ログインしてください",
    scrobble_auth_cancel: "キャンセル",
    scrobble_auth_link_expired: "認証リンクは無効になりました。もう一度サインインして新しいリンクを取得してください。",
    scrobble_import_loves: "お気に入りをインポート",
    scrobble_import_loves_desc: "プロフィールで付けたものが「お気に入り」に入ります。送り返すことはありません。",
    scrobble_import_run: "インポート",
    scrobble_import_result_t: "ライブラリ内で一致: {}/{}",
    scrobble_importing: "インポート中…",
    ...
    native_rate_failed_t: "ネイティブサンプルレートを有効にできませんでした: {}",
    failed_switch_device_t: "デバイスを切り替えられませんでした: {}",
    failed_save_settings_t: "設定を保存できませんでした: {}",
    remote_start_failed_t: "ポート {} でリモート操作サーバーを起動できませんでした: {}",
    ...
    tag_editor_desc: "各トラックにタグ編集ボタンを表示する",
    tag_save: "保存",
    tag_title: "タイトル",
    tag_artists: "アーティスト",
    tag_album: "アルバム",
    tag_album_artists: "アルバムアーティスト",
    tag_track_number: "トラック番号",
    tag_disc_number: "ディスク番号",
    tag_year: "年",
    tag_genres: "ジャンル",
    tag_add_genre: "ジャンルを追加",
    tag_all_tags: "ファイル内のすべてのタグ",
    tag_custom_key: "タグ名",
    tag_custom_value: "値",
    tag_custom_invalid: "このタグ名は使用できません。無効な名前か、すでに上のフィールドにあります。",
    tag_custom_invalid_len: "ID3v2 は4文字のタグ名を保存できません（フレームIDと同じ長さです）。もっと長い名前にしてください。",
    tag_cover: "カバー",
    tag_cover_replace: "置き換え…",
    tag_cover_remove: "削除",
    tag_cover_will_remove: "保存時にカバーが削除されます。",
    tag_cover_album_hint: "アルバムのすべてのファイルに書き込まれます。",
    tag_cover_failed_title: "この画像は使用できません",
    ...
    tags_save_failed_t: "タグの書き込みに失敗しました: {}",
};
