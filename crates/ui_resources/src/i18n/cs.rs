...
pub static CS: Strings = lang! {
    ...
    subsonic_synced_t: "Skladeb na serveru: {}, spárováno s místními: {}",
    ...
    remove_server_confirm_message: "Jeho skladby zmizí z knihovny. Oblíbené a playlisty si je ponechají a vrátí se, když server znovu přidáte.",
