...
pub static CS: Strings = lang! {
    ...
    subsonic_servers_desc: "Navidrome, Gonic, Airsonic a další servery kompatibilní se Subsonic.",
    ...
    album_to_local: "Přesunout do místní knihovny",
    album_to_local_progress_t: "Přesouvání: {} z {} · kliknutím zastavíte",
    album_to_local_done_t: "Album přesunuto do {}",
    album_to_local_failed_t: "Nepřesunulo se vše: {}",
    album_to_local_pick_title: "Přesunout album do",
    cache_used: "Obsazeno",
    cache_clear: "Vymazat",
    cache_limit: "Limit",
    ...
    torrent_upload_desc: "Pawse sdílí jen během stahování z torrentu a 15 minut poté.",
