...
pub static CS: Strings = lang! {
    ...
    subsonic_url: "Adresa serveru",
    subsonic_username: "Uživatelské jméno",
    subsonic_password: "Heslo",
    subsonic_connect: "Připojit",
    subsonic_sync: "Synchronizovat",
    subsonic_import_stars: "Importovat oblíbené",
    network_cache: "Síťová mezipaměť",
    network_cache_desc: "Skladby ze síťových zdrojů uložené pro přehrávání.",
    cache_used: "Obsazeno",
    cache_clear: "Vymazat",
    cache_limit: "Limit",
    ...
    size_mb_t: "{} MB",
    size_gb_t: "{} GB",
    subsonic_auth_failed: "Nesprávné uživatelské jméno nebo heslo",
    subsonic_unreachable_t: "Server je nedostupný: {}",
    subsonic_fill_fields: "Vyplňte adresu a uživatelské jméno",
