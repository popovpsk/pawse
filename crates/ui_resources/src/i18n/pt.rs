...
pub static PT: Strings = lang! {
    ...
    scrobble_auth_restart: "Abrir novamente",
    scrobble_auth_pending: "Ainda não autorizado. Autorize o pawse na página do navegador e pressione «Confirmar». Se fechou essa página, pressione «Abrir novamente».",
    scrobble_auth_link_expired: "O link de autorização já não é válido. Pressione «Abrir novamente» para obter um novo.",
