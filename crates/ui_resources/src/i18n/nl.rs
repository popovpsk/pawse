...
pub static NL: Strings = lang! {
    ...
    lastfm_status_awaiting: "Autoriseer pawse in je browser en bevestig daarna.",
    ...
    scrobble_auth_restart: "Opnieuw openen",
    scrobble_auth_pending: "Nog niet geautoriseerd. Keur pawse goed op de pagina in je browser en druk dan op Bevestigen. Heb je die pagina gesloten, druk dan op Opnieuw openen.",
    scrobble_auth_link_expired: "De autorisatielink is niet meer geldig. Druk op Opnieuw openen voor een nieuwe.",
