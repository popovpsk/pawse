...
pub static NL: Strings = lang! {
    ...
    subsonic_url: "Serveradres",
    subsonic_username: "Gebruikersnaam",
    subsonic_password: "Wachtwoord",
    subsonic_connect: "Verbinden",
    subsonic_sync: "Synchroniseren",
    subsonic_import_stars: "Favorieten importeren",
    subsonic_auth_failed: "Onjuiste gebruikersnaam of wachtwoord",
    subsonic_unreachable_t: "Server onbereikbaar: {}",
    subsonic_synced_t: "Nummers op server: {}, gekoppeld aan lokale: {}",
    subsonic_fill_fields: "Vul adres en gebruikersnaam in",
    ...
    remove_server_confirm_message: "De nummers verdwijnen uit de bibliotheek. Likes en playlists houden ze vast, en ze komen terug als je de server opnieuw toevoegt.",
    ...
    remove_folder_confirm_message: "De nummers uit deze map worden uit je bibliotheek verwijderd, ook uit afspeellijsten en favorieten.",
