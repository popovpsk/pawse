...
pub static NL: Strings = lang! {
    ...
    subsonic_servers_desc: "Navidrome, Gonic, Airsonic en andere Subsonic-compatibele servers.",
    ...
    album_to_local: "Naar lokale bibliotheek verplaatsen",
    album_to_local_progress_t: "Verplaatsen: {} van {} · klik om te stoppen",
    album_to_local_done_t: "Album verplaatst naar {}",
    album_to_local_failed_t: "Niet alles is verplaatst: {}",
    album_to_local_pick_title: "Album verplaatsen naar",
    ...
    torrent_upload_desc: "Pawse deelt alleen terwijl het van een torrent downloadt, en 15 minuten daarna.",
