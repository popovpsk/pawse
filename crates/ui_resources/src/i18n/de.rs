...
pub static DE: Strings = lang! {
    ...
    subsonic_servers_desc: "Navidrome, Gonic, Airsonic und andere Subsonic-kompatible Server.",
    ...
    album_to_local: "In die lokale Bibliothek verschieben",
    album_to_local_progress_t: "Wird verschoben: {} von {} · klicken zum Stoppen",
    album_to_local_done_t: "Album verschoben nach {}",
    album_to_local_failed_t: "Nicht alles wurde verschoben: {}",
    album_to_local_pick_title: "Album verschieben nach",
    cache_used: "Belegt",
    cache_clear: "Leeren",
    cache_limit: "Limit",
    ...
    torrent_upload_desc: "Pawse lädt nur hoch, solange es von einem Torrent lädt, und 15 Minuten danach.",
