...
pub static DE: Strings = lang! {
    ...
    subsonic_url: "Serveradresse",
    subsonic_username: "Benutzername",
    subsonic_password: "Passwort",
    subsonic_connect: "Verbinden",
    subsonic_sync: "Synchronisieren",
    subsonic_import_stars: "Favoriten importieren",
    subsonic_auth_failed: "Falscher Benutzername oder falsches Passwort",
    subsonic_unreachable_t: "Server nicht erreichbar: {}",
    subsonic_synced_t: "Titel auf dem Server: {}, mit lokalen abgeglichen: {}",
    subsonic_fill_fields: "Adresse und Benutzernamen ausfüllen",
    ...
    remove_server_confirm_message: "Seine Titel verschwinden aus der Bibliothek. Likes und Playlists behalten sie, und sie kehren zurück, wenn du den Server wieder hinzufügst.",
