...
pub static FR: Strings = lang! {
    ...
    library_folder_unavailable_t: "Dossier indisponible : {}. Ses morceaux sont masqués jusqu'à son retour.",
    playback_failed_title: "Échec de la lecture",
    local_folders: "Dossiers locaux",
    server_list: "Serveurs",
    subsonic_servers_desc: "Navidrome, Gonic, Airsonic et autres serveurs compatibles Subsonic. Les morceaux présents aussi dans vos dossiers locaux n'apparaissent qu'une fois.",
    jellyfin_servers_desc: "Serveurs Jellyfin. Connectez-vous une fois : Pawse conserve un jeton d'accès, pas votre mot de passe. Les pistes présentes aussi en local n'apparaissent qu'une fois.",
    ...
    network_cache_desc: "La musique du réseau est gardée sur le disque : un morceau déjà écouté démarre aussitôt, sans téléchargement, et se lit même hors ligne.",
    ...
    cache_fill_too_big_t: "Il faut {}, mais la limite du cache est de {}. Seuls les {} premiers fichiers sur {} seront enregistrés.",
    cache_fill_part: "Enregistrer ce qui tient",
    cache_used: "Utilisé",
    cache_clear: "Vider",
    cache_limit: "Limite",
    cache_limit_desc: "Au-delà de la limite, les morceaux les plus anciens sont supprimés.",
    cache_unlimited: "Illimité",
    decimal_separator: ",",
    size_mb_t: "{} Mo",
    size_gb_t: "{} Go",
    ...
    no_servers_added: "Aucun serveur ajouté",
    torrents: "Torrents",
    torrent_list: "Sources",
    torrents_desc: "Albums partagés via BitTorrent. Pawse ne télécharge que les tags et les pochettes pour la bibliothèque, et récupère un morceau quand vous le lisez.",
    torrent_magnet: "Lien magnet",
    torrent_add: "Ajouter",
    torrent_choose_file: "Choisir un fichier .torrent…",
    torrent_invalid: "Ce n’est ni un lien magnet ni un fichier .torrent",
    no_torrents_added: "Aucun torrent ajouté",
    torrent_upload: "Envoi",
    torrent_upload_desc: "Partager accélère le téléchargement. Pawse partage seulement pendant qu’il télécharge un torrent, et 15 minutes après.",
    torrent_upload_while_active: "Pendant le téléchargement",
    torrent_upload_limited: "Jusqu’à 128 Ko/s",
    torrent_upload_off: "Désactivé",
    torrent_peers_t: "Pairs : {}/{}",
    ...
    source_scanning: "Analyse…",
    unavailable_count_t: "Indisponibles : {}",
    no_music_sources: "Aucune musique ajoutée pour l'instant.",
    open_library_settings: "Réglages de la bibliothèque",
    ...
    settings_now_playing: "Lecture en cours",
    now_playing_details: "Troisième ligne",
    now_playing_details_desc: "Ce qui s'affiche sous le titre et l'artiste",
    ...
    blur_background: "Arrière-plan flou",
    blur_background_desc: "Utiliser la pochette floutée comme arrière-plan",
    blur_background_off: "Désactivé",
    blur_background_cover: "Vue pochette",
    blur_background_all: "Toutes les vues",
    blur_intensity: "Intensité du flou",
    blur_intensity_desc: "À quel point l'arrière-plan est flou",
    blur_interface_opacity: "Opacité de l'interface",
    blur_interface_opacity_desc: "À quel point l'interface est transparente sur le flou",
    ...
    albums_layout: "Disposition",
    albums_layout_desc: "Comment les albums sont affichés dans l'onglet Albums",
    albums_layout_list: "Liste",
    albums_layout_grid: "Grille",
    year_column: "Colonne année",
    year_column_desc: "Afficher la colonne année dans la liste des albums",
    album_year: "Année",
    album_year_desc: "Afficher l'année sous la vignette",
    ...
    scrobble_account: "Compte",
    scrobble_enabled: "Activé",
    scrobble_send_loves: "Envoyer les favoris",
    scrobble_send_loves_desc: "Aimer un titre ici l'ajoute aussi aux favoris du service. Le retirer l'y supprime aussi.",
    scrobble_file: "Fichier",
    scrobble_first_artist: "Scrobbler uniquement le premier artiste",
    scrobble_first_artist_desc: "Envoyer un seul nom d’artiste par titre au lieu de tous les interprètes.",
    scrobble_csv: "Journal CSV",
    scrobble_csv_desc: "Ajouter chaque scrobble à un fichier CSV local.",
    scrobble_file_open: "Ouvrir…",
    scrobble_file_new: "Nouveau…",
    scrobble_not_a_log: "Ce fichier n'est pas un journal de scrobbles pawse.",
    scrobble_token: "Jeton",
    scrobble_server: "Serveur",
    scrobble_connect: "Connecter",
    scrobble_auth_expired: "Autorisation expirée, reconnectez-vous",
    scrobble_auth_cancel: "Annuler",
    scrobble_auth_link_expired: "Le lien d'autorisation n'est plus valide. Reconnectez-vous pour en obtenir un nouveau.",
    scrobble_import_loves: "Importer les coups de cœur",
    scrobble_import_loves_desc: "Ce qui est marqué dans le profil arrive dans « Favoris ». Rien n'est renvoyé.",
    scrobble_import_run: "Importer",
    scrobble_import_result_t: "Trouvés dans la bibliothèque : {} sur {}",
    scrobble_importing: "Importation…",
    ...
    lyrics_karaoke: "Remplissage karaoké",
    lyrics_karaoke_desc: "Remplir la ligne en cours pendant la lecture",
    lyrics_dim_inactive: "Atténuer les autres lignes",
    lyrics_dim_inactive_desc: "Estomper les lignes qui ne sont pas jouées",
