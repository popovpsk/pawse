...
pub static FR: Strings = lang! {
    ...
    subsonic_url: "Adresse du serveur",
    subsonic_username: "Nom d'utilisateur",
    subsonic_password: "Mot de passe",
    subsonic_connect: "Connecter",
    subsonic_sync: "Synchroniser",
    subsonic_import_stars: "Importer les favoris",
    network_cache: "Cache réseau",
    network_cache_desc: "Morceaux des sources réseau enregistrés pour la lecture.",
    cache_used: "Utilisé",
    cache_clear: "Vider",
    cache_limit: "Limite",
    ...
    size_mb_t: "{} Mo",
    size_gb_t: "{} Go",
    subsonic_auth_failed: "Nom d'utilisateur ou mot de passe incorrect",
    subsonic_unreachable_t: "Serveur injoignable : {}",
    subsonic_fill_fields: "Renseignez l'adresse et le nom d'utilisateur",
