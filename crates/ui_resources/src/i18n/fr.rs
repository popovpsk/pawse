...
pub static FR: Strings = lang! {
    ...
    subsonic_servers_desc: "Navidrome, Gonic, Airsonic et autres serveurs compatibles Subsonic.",
    ...
    album_to_local: "Déplacer vers la bibliothèque locale",
    album_to_local_progress_t: "Déplacement : {} sur {} · cliquez pour arrêter",
    album_to_local_done_t: "Album déplacé vers {}",
    album_to_local_failed_t: "Tout n'a pas été déplacé : {}",
    album_to_local_pick_title: "Déplacer l'album vers",
    cache_used: "Utilisé",
    cache_clear: "Vider",
    cache_limit: "Limite",
    ...
    torrent_upload_desc: "Pawse partage seulement pendant qu’il télécharge un torrent, et 15 minutes après.",
