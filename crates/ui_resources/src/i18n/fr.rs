...
pub static FR: Strings = lang! {
    ...
    scrobble_auth_restart: "Rouvrir",
    scrobble_auth_pending: "Pas encore autorisé. Autorisez pawse sur la page ouverte dans votre navigateur, puis appuyez sur « Confirmer ». Si vous avez fermé cette page, appuyez sur « Rouvrir ».",
    scrobble_auth_link_expired: "Le lien d'autorisation n'est plus valide. Appuyez sur « Rouvrir » pour en obtenir un nouveau.",
