...
pub static FR: Strings = lang! {
    ...
    subsonic_synced_t: "Morceaux sur le serveur : {}, associés aux locaux : {}",
    ...
    remove_server_confirm_message: "Ses morceaux disparaissent de la bibliothèque. Les favoris et les playlists les conservent, et ils reviennent si vous ajoutez à nouveau le serveur.",
