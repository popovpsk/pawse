...
pub static ID: Strings = lang! {
    ...
    lastfm_status_awaiting: "Izinkan pawse di browser, lalu konfirmasi.",
    ...
    scrobble_auth_restart: "Buka lagi",
    scrobble_auth_pending: "Belum diotorisasi. Setujui pawse di halaman pada peramban, lalu tekan Konfirmasi. Jika halaman itu tertutup, tekan Buka lagi.",
    scrobble_auth_link_expired: "Tautan otorisasi sudah tidak berlaku. Tekan Buka lagi untuk mendapatkan yang baru.",
