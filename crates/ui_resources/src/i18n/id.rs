...
pub static ID: Strings = lang! {
    ...
    subsonic_servers_desc: "Navidrome, Gonic, Airsonic, dan server lain yang kompatibel dengan Subsonic.",
    ...
    album_to_local: "Pindahkan ke pustaka lokal",
    album_to_local_progress_t: "Memindahkan: {} dari {} · klik untuk berhenti",
    album_to_local_done_t: "Album dipindahkan ke {}",
    album_to_local_failed_t: "Tidak semua berhasil dipindahkan: {}",
    album_to_local_pick_title: "Pindahkan album ke",
    cache_used: "Terpakai",
    ...
    torrent_upload_desc: "Pawse hanya berbagi saat mengunduh dari torrent dan 15 menit setelahnya.",
