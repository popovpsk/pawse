...
pub static ID: Strings = lang! {
    ...
    subsonic_url: "Alamat server",
    subsonic_username: "Nama pengguna",
    subsonic_password: "Kata sandi",
    subsonic_connect: "Hubungkan",
    subsonic_sync: "Sinkronkan",
    subsonic_import_stars: "Impor favorit",
    subsonic_auth_failed: "Nama pengguna atau kata sandi salah",
    subsonic_unreachable_t: "Server tidak dapat dijangkau: {}",
    subsonic_synced_t: "Lagu di server: {}, cocok dengan lokal: {}",
    subsonic_fill_fields: "Isi alamat dan nama pengguna",
    ...
    remove_server_confirm_message: "Lagunya hilang dari pustaka. Suka dan playlist tetap menyimpannya, dan lagu kembali jika server ditambahkan lagi.",
    ...
    remove_folder_confirm_message: "Trek dari folder ini akan dihapus dari pustaka Anda, termasuk dari playlist dan disukai.",
