...
pub static ID: Strings = lang! {
    ...
    network_cache_desc: "Musik dari jaringan disimpan di disk: lagu yang pernah diputar langsung mulai tanpa diunduh lagi, bahkan tanpa internet.",
    ...
    cache_fill_too_big_t: "Dibutuhkan {}, tetapi batas cache {}. Hanya {} dari {} file pertama yang akan disimpan.",
    cache_fill_part: "Simpan yang muat",
    cache_used: "Terpakai",
    cache_clear: "Kosongkan",
    cache_limit: "Batas",
    cache_limit_desc: "Saat cache melewati batas, lagu terlama dihapus.",
    cache_unlimited: "Tanpa batas",
    decimal_separator: ",",
    size_mb_t: "{} MB",
    size_gb_t: "{} GB",
    ...
    torrents: "Torrent",
    torrent_list: "Sumber",
    torrents_desc: "Album yang dibagikan lewat BitTorrent. Pawse hanya mengunduh tag dan sampul untuk pustaka, dan mengambil lagu saat Anda memutarnya.",
    torrent_magnet: "Tautan magnet",
    torrent_add: "Tambah",
    torrent_choose_file: "Pilih file .torrent…",
    torrent_invalid: "Bukan tautan magnet atau file .torrent",
    no_torrents_added: "Belum ada torrent",
    torrent_upload: "Unggah",
    torrent_upload_desc: "Berbagi mempercepat unduhan. Pawse hanya berbagi saat mengunduh dari torrent dan 15 menit setelahnya.",
    torrent_upload_while_active: "Saat mengunduh",
    torrent_upload_limited: "Hingga 128 KB/d",
    torrent_upload_off: "Mati",
