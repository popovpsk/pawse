...
pub static TH: Strings = lang! {
    ...
    subsonic_url: "ที่อยู่เซิร์ฟเวอร์",
    subsonic_username: "ชื่อผู้ใช้",
    subsonic_password: "รหัสผ่าน",
    subsonic_connect: "เชื่อมต่อ",
    subsonic_sync: "ซิงค์",
    subsonic_import_stars: "นำเข้ารายการโปรด",
    network_cache: "แคชเครือข่าย",
    network_cache_desc: "เพลงจากแหล่งเครือข่ายที่บันทึกไว้สำหรับเล่น",
    cache_used: "ใช้ไป",
    cache_clear: "ล้าง",
    ...
    size_mb_t: "{} MB",
    size_gb_t: "{} GB",
    subsonic_auth_failed: "ชื่อผู้ใช้หรือรหัสผ่านไม่ถูกต้อง",
    subsonic_unreachable_t: "เข้าถึงเซิร์ฟเวอร์ไม่ได้: {}",
    subsonic_fill_fields: "กรอกที่อยู่และชื่อผู้ใช้",
