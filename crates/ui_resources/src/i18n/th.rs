...
pub static TH: Strings = lang! {
    ...
    subsonic_servers_desc: "Navidrome, Gonic, Airsonic และเซิร์ฟเวอร์อื่นที่รองรับ Subsonic",
    ...
    album_to_local: "ย้ายไปคลังเพลงในเครื่อง",
    album_to_local_progress_t: "กำลังย้าย: {} จาก {} · คลิกเพื่อหยุด",
    album_to_local_done_t: "ย้ายอัลบั้มไปที่ {} แล้ว",
    album_to_local_failed_t: "ย้ายไม่ครบทั้งหมด: {}",
    album_to_local_pick_title: "ย้ายอัลบั้มไปที่",
    cache_used: "ใช้ไป",
    cache_clear: "ล้าง",
    ...
    torrent_upload_desc: "Pawse แชร์เฉพาะขณะดาวน์โหลดจากทอร์เรนต์ และอีก 15 นาทีหลังจากนั้น",
