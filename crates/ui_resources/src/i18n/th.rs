...
pub static TH: Strings = lang! {
    ...
    local_folders: "โฟลเดอร์ในเครื่อง",
    server_list: "เซิร์ฟเวอร์",
    subsonic_servers_desc: "Navidrome, Gonic, Airsonic และเซิร์ฟเวอร์อื่นที่รองรับ Subsonic เพลงที่มีในโฟลเดอร์ในเครื่องด้วยจะแสดงเพียงครั้งเดียว",
    jellyfin_servers_desc: "เซิร์ฟเวอร์ Jellyfin ลงชื่อเข้าใช้เพียงครั้งเดียว — Pawse เก็บโทเค็นการเข้าถึง ไม่ใช่รหัสผ่านของคุณ แทร็กที่มีในเครื่องด้วยจะแสดงเพียงครั้งเดียว",
    server_url: "ที่อยู่เซิร์ฟเวอร์",
    server_username: "ชื่อผู้ใช้",
    server_password: "รหัสผ่าน",
    server_connect: "เชื่อมต่อ",
    server_sync: "ซิงค์",
    server_import_favorites: "นำเข้ารายการโปรด",
    network_cache: "แคชเครือข่าย",
    network_cache_desc: "เพลงจากเครือข่ายจะถูกเก็บไว้บนดิสก์ แทร็กที่เคยเล่นแล้วจะเริ่มทันทีโดยไม่ต้องดาวน์โหลด และเล่นได้แม้ไม่มีอินเทอร์เน็ต",
    cache_fill: "บันทึกลงแคช",
    cache_fill_progress_t: "บันทึกแล้ว {} จาก {} · คลิกเพื่อหยุด",
    cache_fill_too_big_title: "แคชเก็บได้ไม่ทั้งหมด",
    cache_fill_too_big_t: "ต้องใช้ {} แต่ขีดจำกัดแคชคือ {} จะบันทึกเฉพาะ {} ไฟล์แรกจาก {} ไฟล์",
    cache_fill_part: "บันทึกเท่าที่เก็บได้",
    cache_used: "ใช้ไป",
    cache_clear: "ล้าง",
    cache_limit: "ขีดจำกัด",
    cache_limit_desc: "เมื่อแคชเกินขีดจำกัด เพลงที่เก่าที่สุดจะถูกลบ",
    cache_unlimited: "ไม่จำกัด",
    decimal_separator: ".",
    size_mb_t: "{} MB",
    size_gb_t: "{} GB",
    ...
    no_servers_added: "ยังไม่ได้เพิ่มเซิร์ฟเวอร์",
    torrents: "ทอร์เรนต์",
    torrent_list: "แหล่งที่มา",
    torrents_desc: "อัลบั้มที่แชร์ผ่าน BitTorrent Pawse ดาวน์โหลดเฉพาะแท็กและปกเพื่อสร้างคลัง และดึงแทร็กเมื่อคุณเล่น",
    torrent_magnet: "ลิงก์ magnet",
    torrent_add: "เพิ่ม",
    torrent_choose_file: "เลือกไฟล์ .torrent…",
    torrent_invalid: "ไม่ใช่ลิงก์ magnet หรือไฟล์ .torrent",
    no_torrents_added: "ยังไม่ได้เพิ่มทอร์เรนต์",
    torrent_upload: "การอัปโหลด",
    torrent_upload_desc: "การแชร์กลับช่วยให้ดาวน์โหลดเร็วขึ้น Pawse แชร์เฉพาะขณะดาวน์โหลดจากทอร์เรนต์ และอีก 15 นาทีหลังจากนั้น",
    torrent_upload_while_active: "ขณะดาวน์โหลด",
    torrent_upload_limited: "สูงสุด 128 KB/s",
    torrent_upload_off: "ปิด",
    torrent_peers_t: "เพียร์: {}/{}",
    ...
    source_scanning: "กำลังสแกน…",
    unavailable_count_t: "ไม่พร้อมใช้งาน: {}",
    no_music_sources: "ยังไม่ได้เพิ่มเพลง",
    open_library_settings: "การตั้งค่าคลัง",
    ...
    settings_now_playing: "กำลังเล่น",
    now_playing_details: "บรรทัดที่สาม",
    now_playing_details_desc: "สิ่งที่แสดงใต้ชื่อเพลงและศิลปิน",
    now_playing_details_specs: "รูปแบบ",
    now_playing_details_album: "อัลบั้ม",
    ...
    blur_background: "พื้นหลังเบลอ",
    blur_background_desc: "ใช้ภาพปกที่เบลอเป็นพื้นหลัง",
    blur_background_off: "ปิด",
    blur_background_cover: "มุมมองปก",
    blur_background_all: "ทุกมุมมอง",
    blur_intensity: "ความเข้มของเบลอ",
    blur_intensity_desc: "พื้นหลังเบลอแค่ไหน",
    blur_interface_opacity: "ความทึบของอินเทอร์เฟซ",
    blur_interface_opacity_desc: "อินเทอร์เฟซโปร่งใสแค่ไหนเหนือความเบลอ",
    ...
    albums_layout: "เค้าโครง",
    albums_layout_desc: "วิธีแสดงอัลบั้มในแท็บอัลบั้ม",
    albums_layout_list: "รายการ",
    albums_layout_grid: "ตาราง",
    year_column: "คอลัมน์ปี",
    year_column_desc: "แสดงคอลัมน์ปีในรายการอัลบั้ม",
    album_year: "ปี",
    album_year_desc: "แสดงปีในคำบรรยายไทล์",
    ...
    native_rate_title: "อัตราสุ่มตัวอย่างดั้งเดิม",
    ...
    lastfm_status_connected: "เชื่อมต่อแล้ว",
    lastfm_sign_in: "ลงชื่อเข้าใช้",
    lastfm_sign_out: "ออกจากระบบ",
    lastfm_unavailable: "Last.fm ไม่ได้ตั้งค่าไว้ในบิลด์นี้",
    settings_scrobbling: "Scrobble",
    scrobble_account: "บัญชี",
    scrobble_enabled: "เปิดใช้งาน",
    scrobble_send_loves: "ส่งรายการที่ชอบ",
    scrobble_send_loves_desc: "การกดชอบที่นี่จะเพิ่มเพลงในรายการโปรดของบริการด้วย การยกเลิกจะลบออกจากที่นั่น",
    scrobble_file: "ไฟล์",
    scrobble_first_artist: "Scrobble เฉพาะศิลปินคนแรก",
    scrobble_first_artist_desc: "ส่งชื่อศิลปินเดียวต่อเพลงแทนการรวมผู้แสดงทั้งหมด",
    scrobble_csv: "บันทึก CSV",
    scrobble_csv_desc: "เพิ่มทุก Scrobble ลงในไฟล์ CSV ในเครื่อง",
    scrobble_file_open: "เปิด…",
    scrobble_file_new: "สร้างใหม่…",
    scrobble_not_a_log: "ไฟล์นี้ไม่ใช่บันทึก scrobble ของ pawse",
    scrobble_token: "โทเคน",
    scrobble_server: "เซิร์ฟเวอร์",
    scrobble_connect: "เชื่อมต่อ",
    scrobble_auth_expired: "การอนุญาตหมดอายุ โปรดเข้าสู่ระบบอีกครั้ง",
    scrobble_auth_cancel: "ยกเลิก",
    scrobble_auth_link_expired: "ลิงก์การอนุญาตใช้ไม่ได้แล้ว กรุณาเข้าสู่ระบบอีกครั้งเพื่อรับลิงก์ใหม่",
    scrobble_import_loves: "นำเข้าเพลงที่ถูกใจ",
    scrobble_import_loves_desc: "สิ่งที่ทำเครื่องหมายไว้ในโปรไฟล์จะถูกเพิ่มใน «เพลงที่ถูกใจ» ไม่มีการส่งกลับ",
    scrobble_import_run: "นำเข้า",
    scrobble_import_result_t: "พบในคลัง: {}/{}",
    scrobble_importing: "กำลังนำเข้า…",
    ...
    native_rate_failed_t: "ไม่สามารถเปิดอัตราสุ่มตัวอย่างดั้งเดิมได้: {}",
    failed_switch_device_t: "ไม่สามารถสลับอุปกรณ์: {}",
    failed_save_settings_t: "ไม่สามารถบันทึกการตั้งค่า: {}",
    remote_start_failed_t: "ไม่สามารถเริ่มเซิร์ฟเวอร์ควบคุมระยะไกลบนพอร์ต {} ได้: {}",
    ...
    tag_editor_desc: "แสดงปุ่มแก้ไขแท็กในแต่ละแทร็ก",
    tag_save: "บันทึก",
    tag_title: "ชื่อเพลง",
    tag_artists: "ศิลปิน",
    tag_album: "อัลบั้ม",
    tag_album_artists: "ศิลปินอัลบั้ม",
    tag_track_number: "หมายเลขแทร็ก",
    tag_disc_number: "หมายเลขแผ่น",
    tag_year: "ปี",
    tag_genres: "แนวเพลง",
    tag_add_genre: "เพิ่มแนวเพลง",
    tag_all_tags: "แท็กทั้งหมดในไฟล์",
    tag_custom_key: "ชื่อแท็ก",
    tag_custom_value: "ค่า",
    tag_custom_invalid: "ใช้ชื่อแท็กนี้ไม่ได้ — ชื่อไม่ถูกต้องหรือมีอยู่แล้วในช่องด้านบน",
    tag_custom_invalid_len: "ID3v2 เก็บชื่อแท็กยาว 4 ตัวอักษรไม่ได้ เพราะนั่นคือความยาวของ frame id กรุณาใช้ชื่อที่ยาวกว่านี้",
    tag_cover: "ปกอัลบั้ม",
    tag_cover_replace: "แทนที่…",
    tag_cover_remove: "ลบออก",
    tag_cover_will_remove: "ปกจะถูกลบเมื่อบันทึก",
    tag_cover_album_hint: "จะถูกเขียนลงในทุกไฟล์ของอัลบั้ม",
    tag_cover_failed_title: "ไม่สามารถใช้รูปภาพนี้ได้",
    tag_cover_unreadable: "อ่านไฟล์นี้ไม่ได้",
    tag_cover_bad_format: "ปกต้องเป็นไฟล์ JPEG หรือ PNG",
    tag_cue_readonly: "แทร็กนี้มาจากไฟล์ CUE แท็กของแทร็กอยู่ในไฟล์ .cue และแก้ไขที่นี่ไม่ได้",
    tag_playing_readonly: "นี่คือแทร็กปัจจุบัน การบันทึกจะเขียนทับไฟล์ที่ตัวเล่นเปิดอยู่ — โปรดเปลี่ยนไปแทร็กอื่นก่อน",
    tag_album_playing_readonly: "แทร็กปัจจุบันอยู่ในอัลบั้มนี้ การบันทึกจะเขียนทับไฟล์ที่ตัวเล่นเปิดอยู่ — โปรดเปลี่ยนไปแทร็กอื่นก่อน",
    tag_album_fields_hint: "ช่องข้อมูลอัลบั้มมีผลกับทั้งอัลบั้ม — แก้ไขได้ในตัวแก้ไขแท็กอัลบั้ม",
    tags_saved: "บันทึกแท็กแล้ว",
    tag_write_failed_title: "เขียนแท็กไม่สำเร็จ",
    tags_save_failed_t: "เขียนแท็กไม่สำเร็จ: {}",
};
