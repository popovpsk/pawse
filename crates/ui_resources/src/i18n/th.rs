...
pub static TH: Strings = lang! {
    ...
    subsonic_synced_t: "เพลงบนเซิร์ฟเวอร์: {} ตรงกับในเครื่อง: {}",
    ...
    remove_server_confirm_message: "เพลงของเซิร์ฟเวอร์นี้จะหายจากคลัง รายการที่ชอบและเพลย์ลิสต์ยังเก็บไว้ และจะกลับมาเมื่อเพิ่มเซิร์ฟเวอร์อีกครั้ง",
