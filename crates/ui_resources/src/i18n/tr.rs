...
pub static TR: Strings = lang! {
    ...
    subsonic_servers_desc: "Navidrome, Gonic, Airsonic ve diğer Subsonic uyumlu sunucular.",
    ...
    album_to_local: "Yerel kitaplığa taşı",
    album_to_local_progress_t: "Taşınıyor: {} / {} · durdurmak için tıklayın",
    album_to_local_done_t: "Albüm şuraya taşındı: {}",
    album_to_local_failed_t: "Her şey taşınamadı: {}",
    album_to_local_pick_title: "Albümü şuraya taşı",
    ...
    torrent_upload_desc: "Pawse yalnızca bir torrentten indirirken ve sonrasında 15 dakika paylaşır.",
