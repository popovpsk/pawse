...
pub static TR: Strings = lang! {
    ...
    subsonic_url: "Sunucu adresi",
    subsonic_username: "Kullanıcı adı",
    subsonic_password: "Parola",
    subsonic_connect: "Bağlan",
    subsonic_sync: "Eşitle",
    subsonic_import_stars: "Favorileri içe aktar",
    network_cache: "Ağ önbelleği",
    network_cache_desc: "Çalmak için kaydedilen ağ kaynağı parçaları.",
    ...
    size_mb_t: "{} MB",
    size_gb_t: "{} GB",
    subsonic_auth_failed: "Kullanıcı adı veya parola yanlış",
    subsonic_unreachable_t: "Sunucuya ulaşılamıyor: {}",
    subsonic_fill_fields: "Adresi ve kullanıcı adını doldurun",
