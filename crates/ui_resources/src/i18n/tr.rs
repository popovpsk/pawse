...
pub static TR: Strings = lang! {
    ...
    library_folder_unavailable_t: "Klasör kullanılamıyor: {}. Geri gelene kadar parçaları gizlenir.",
    playback_failed_title: "Oynatma başarısız",
    local_folders: "Yerel klasörler",
    server_list: "Sunucular",
    subsonic_servers_desc: "Navidrome, Gonic, Airsonic ve diğer Subsonic uyumlu sunucular. Yerel klasörlerde de bulunan parçalar bir kez görünür.",
    jellyfin_servers_desc: "Jellyfin sunucuları. Bir kez oturum açın — Pawse parolanızı değil, bir erişim belirtecini saklar. Yerelde de bulunan parçalar bir kez görünür.",
    server_url: "Sunucu adresi",
    server_username: "Kullanıcı adı",
    server_password: "Parola",
    server_connect: "Bağlan",
    server_sync: "Eşitle",
    server_import_favorites: "Favorileri içe aktar",
    network_cache: "Ağ önbelleği",
    network_cache_desc: "Ağdan gelen müzik diskte saklanır: daha önce çalınan parça indirme olmadan hemen başlar ve internet olmadan da çalar.",
    ...
    cache_fill_too_big_t: "{} gerekiyor ama önbellek sınırı {}. Yalnızca ilk {} dosya kaydedilecek (toplam {}).",
    cache_fill_part: "Sığanı kaydet",
    cache_used: "Kullanılan",
    cache_clear: "Temizle",
    cache_limit: "Sınır",
    cache_limit_desc: "Önbellek sınırı aşınca en eski parçalar silinir.",
    cache_unlimited: "Sınırsız",
    decimal_separator: ",",
    size_mb_t: "{} MB",
    size_gb_t: "{} GB",
    ...
    no_servers_added: "Sunucu eklenmedi",
    torrents: "Torrentler",
    torrent_list: "Kaynaklar",
    torrents_desc: "BitTorrent ile paylaşılan albümler. Pawse kitaplık için yalnızca etiketleri ve kapakları indirir, parçayı çaldığınızda getirir.",
    torrent_magnet: "Magnet bağlantısı",
    torrent_add: "Ekle",
    torrent_choose_file: ".torrent dosyası seç…",
    torrent_invalid: "Magnet bağlantısı veya .torrent dosyası değil",
    no_torrents_added: "Torrent eklenmedi",
    torrent_upload: "Yükleme",
    torrent_upload_desc: "Paylaşmak indirmeyi hızlandırır. Pawse yalnızca bir torrentten indirirken ve sonrasında 15 dakika paylaşır.",
    torrent_upload_while_active: "İndirirken",
    torrent_upload_limited: "En fazla 128 KB/s",
    torrent_upload_off: "Kapalı",
    torrent_peers_t: "Eşler: {}/{}",
    ...
    source_scanning: "Taranıyor…",
    unavailable_count_t: "Kullanılamayan: {}",
    no_music_sources: "Henüz müzik eklenmedi.",
    open_library_settings: "Kitaplık ayarları",
    ...
    settings_now_playing: "Şimdi çalıyor",
    now_playing_details: "Üçüncü satır",
    now_playing_details_desc: "Parça adı ve sanatçının altında ne gösterilsin",
    now_playing_details_specs: "Biçim",
    now_playing_details_album: "Albüm",
    ...
    blur_background: "Bulanık arka plan",
    blur_background_desc: "Bulanık kapak görselini arka plan olarak kullan",
    blur_background_off: "Kapalı",
    blur_background_cover: "Kapak görünümü",
    blur_background_all: "Tüm görünümler",
    blur_intensity: "Bulanıklık yoğunluğu",
    blur_intensity_desc: "Arka planın ne kadar bulanık olduğu",
    blur_interface_opacity: "Arayüz opaklığı",
    blur_interface_opacity_desc: "Arayüzün bulanıklık üzerinde ne kadar saydam olduğu",
    ...
    albums_layout: "Yerleşim",
    albums_layout_desc: "Albümler sekmesinde albümlerin gösterilme biçimi",
    albums_layout_list: "Liste",
    albums_layout_grid: "Izgara",
    year_column: "Yıl sütunu",
    year_column_desc: "Albüm listesinde yıl sütununu göster",
    album_year: "Yıl",
    album_year_desc: "Yılı küçük resim açıklamasında göster",
    ...
    scrobble_account: "Hesap",
    scrobble_enabled: "Etkin",
    scrobble_send_loves: "Beğenileri gönder",
    scrobble_send_loves_desc: "Buradaki beğeni parçayı serviste de favorilere ekler. Kaldırmak onu oradan da siler.",
    scrobble_file: "Dosya",
    scrobble_first_artist: "Yalnızca ilk sanatçıyı scrobble et",
    scrobble_first_artist_desc: "Tüm sanatçıları birleştirmek yerine parça başına tek bir sanatçı adı gönder.",
    scrobble_csv: "CSV günlüğü",
    scrobble_csv_desc: "Her scrobble’ı yerel bir CSV dosyasına ekle.",
    scrobble_file_open: "Aç…",
    scrobble_file_new: "Yeni…",
    scrobble_not_a_log: "Bu dosya bir pawse scrobble günlüğü değil.",
    scrobble_token: "Belirteç",
    scrobble_server: "Sunucu",
    scrobble_connect: "Bağlan",
    scrobble_auth_expired: "Yetkilendirme süresi doldu, tekrar giriş yap",
    scrobble_auth_cancel: "İptal",
    scrobble_auth_link_expired: "Yetkilendirme bağlantısının süresi doldu. Yenisini almak için tekrar giriş yap.",
    scrobble_import_loves: "Beğenilen parçaları içe aktar",
    scrobble_import_loves_desc: "Profilinde işaretli olanlar «Beğenilen parçalar»a eklenir. Geri bir şey gönderilmez.",
    scrobble_import_run: "İçe aktar",
    scrobble_import_result_t: "Kitaplığında bulundu: {}/{}",
    scrobble_importing: "İçe aktarılıyor…",
