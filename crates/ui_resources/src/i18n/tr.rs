...
pub static TR: Strings = lang! {
    ...
    scrobble_auth_restart: "Yeniden aç",
    scrobble_auth_pending: "Henüz yetkilendirilmedi. Tarayıcıdaki sayfada pawse'a izin verin, sonra Onayla'ya basın. Sayfayı kapattıysanız Yeniden aç'a basın.",
    scrobble_auth_link_expired: "Yetkilendirme bağlantısı artık geçerli değil. Yenisi için Yeniden aç'a basın.",
