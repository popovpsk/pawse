...
pub static TR: Strings = lang! {
    ...
    subsonic_synced_t: "Sunucudaki parçalar: {}, yerellerle eşleşen: {}",
    ...
    remove_server_confirm_message: "Parçaları kitaplıktan kaybolur. Beğeniler ve çalma listeleri onları korur; sunucuyu yeniden eklerseniz geri gelirler.",
