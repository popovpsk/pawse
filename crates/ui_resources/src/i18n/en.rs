...
pub static EN: Strings = lang! {
    ...
    subsonic_synced_t: "Tracks on server: {}, matched with local: {}",
    ...
    remove_server_confirm_message: "Its tracks disappear from the library. Likes and playlists keep them, and they come back if you add the server again.",
