...
pub static EN: Strings = lang! {
    ...
    lastfm_status_awaiting: "Authorize pawse in your browser, then confirm.",
    ...
    scrobble_auth_restart: "Open again",
    scrobble_auth_pending: "Not authorized yet. Approve pawse on the page in your browser, then press Confirm. If you closed that page, press Open again.",
    scrobble_auth_link_expired: "The authorization link is no longer valid. Press Open again to get a new one.",
