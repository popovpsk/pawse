...
pub static EN: Strings = lang! {
    ...
    scanning: "Scanning...",
    library_updating: "Updating library…",
    library_updated: "Library updated",
    library_up_to_date: "Library is up to date",
    library_update_failed: "Library update failed",
    library_folder_unavailable_t: "Folder unavailable: {}. Its tracks are hidden until it's back.",
    playback_failed_title: "Playback failed",
    local_folders: "Local folders",
    server_list: "Servers",
    subsonic_servers_desc: "Navidrome, Gonic, Airsonic and other Subsonic-compatible servers. Tracks you also have in local folders appear once.",
    jellyfin_servers_desc: "Jellyfin servers. Sign in once — Pawse keeps an access token, not your password. Tracks you also have locally appear once.",
    ...
    network_cache_desc: "Music from the network is kept on disk: a track you have played starts at once, without downloading, and plays even offline.",
    ...
    cache_fill_too_big_t: "This needs {}, but the cache limit is {}. Only the first {} of {} files will be saved.",
    cache_fill_part: "Save what fits",
    cache_used: "In use",
    cache_clear: "Clear",
    cache_limit: "Limit",
    cache_limit_desc: "Once the cache passes the limit, the oldest tracks are removed.",
    cache_unlimited: "Unlimited",
    decimal_separator: ".",
    size_mb_t: "{} MB",
    size_gb_t: "{} GB",
    ...
    no_servers_added: "No servers added",
    torrents: "Torrents",
    torrent_list: "Sources",
    torrents_desc: "Albums shared over BitTorrent. Pawse downloads only tags and covers to build the library, and fetches a track when you play it.",
    torrent_magnet: "Magnet link",
    torrent_add: "Add",
    torrent_choose_file: "Choose .torrent file…",
    torrent_invalid: "Not a magnet link or a .torrent file",
    no_torrents_added: "No torrents added",
    torrent_upload: "Uploading",
    torrent_upload_desc: "Sharing back speeds up downloads. Pawse shares only while it downloads from a torrent, and for 15 minutes after.",
    torrent_upload_while_active: "While downloading",
    torrent_upload_limited: "Up to 128 KB/s",
    torrent_upload_off: "Off",
    ...
    source_scanning: "Scanning…",
    unavailable_count_t: "Unavailable: {}",
    no_music_sources: "No music added yet.",
    open_library_settings: "Library settings",
    ...
    settings_now_playing: "Now playing",
    now_playing_details: "Third line",
    now_playing_details_desc: "What to show under the track title and the artist",
    now_playing_details_specs: "Specs",
    ...
    blur_background: "Blurred background",
    blur_background_desc: "Use the blurred cover art as the background",
    blur_background_off: "Off",
    blur_background_cover: "Cover view",
    blur_background_all: "All views",
    blur_intensity: "Blur intensity",
    blur_intensity_desc: "How blurry the background is",
    blur_interface_opacity: "Interface opacity",
    blur_interface_opacity_desc: "How see-through the interface is over the blur",
    ...
    settings_albums_view: "Albums view",
    albums_layout: "Layout",
    albums_layout_desc: "How albums are shown in the Albums tab",
    albums_layout_list: "List",
    albums_layout_grid: "Grid",
    year_column: "Year column",
    year_column_desc: "Show the year column in the albums list",
    album_year: "Year",
    album_year_desc: "Show the year in the tile caption",
    genre_column: "Genre column",
    genre_column_desc: "Show the genre column in the albums list",
    albums_artist_desc: "How the album artist is shown in the list",
    albums_artist_inline: "Inline",
    albums_artist_column: "Column",
    ...
    native_rate_title: "Native sample rate",
    ...
    lastfm_status_connected: "Connected",
    lastfm_sign_in: "Sign in",
    lastfm_sign_out: "Sign out",
    lastfm_unavailable: "Last.fm is not configured in this build.",
    settings_scrobbling: "Scrobbling",
    scrobble_account: "Account",
    scrobble_enabled: "Enabled",
    scrobble_send_loves: "Send likes",
    scrobble_send_loves_desc: "Liking a track here also loves it on the service. Unliking removes it there too.",
    scrobble_file: "File",
    scrobble_first_artist: "Scrobble the first artist only",
    scrobble_first_artist_desc: "Send one artist name per track instead of joining every performer into one.",
    scrobble_csv: "CSV log",
    scrobble_csv_desc: "Append every scrobble to a local CSV file.",
    scrobble_file_open: "Open…",
    scrobble_file_new: "New…",
    scrobble_not_a_log: "That file isn't a pawse scrobble log.",
    scrobble_token: "Token",
    scrobble_server: "Server",
    scrobble_connect: "Connect",
    ...
    scrobble_import_loves: "Import loved tracks",
    ...
    scrobble_importing: "Importing…",
    discord_share: "Show on Discord",
    discord_share_desc: "Show the track you're playing on your Discord profile.",
    remote_control_desc: "Control playback from a web browser on your local network.",
    remote_port: "Port",
    remote_port_desc: "Network port for the remote control server.",
    ...
    native_rate_failed_t: "Failed to enable native sample rate: {}",
    failed_switch_device_t: "Failed to switch device: {}",
    failed_save_settings_t: "Failed to save settings: {}",
    remote_start_failed_t: "Couldn't start the remote control server on port {}: {}",
    update_ready_t: "Pawse {} is ready to install",
    update_check_failed_t: "Update check failed: {}",
    ...
    tag_editor_desc: "Show an edit button on each track for changing its tags",
    tag_save: "Save",
    tag_title: "Title",
    tag_artists: "Artists",
    tag_album: "Album",
    tag_album_artists: "Album artists",
    tag_track_number: "Track number",
    tag_disc_number: "Disc number",
    tag_year: "Year",
    tag_genres: "Genres",
    tag_add_genre: "Add genre",
    tag_all_tags: "All tags in file",
    tag_custom_key: "Tag name",
    tag_custom_value: "Value",
    tag_custom_invalid: "That tag name cannot be used — it is either invalid or already one of the fields above.",
    tag_custom_invalid_len: "ID3v2 cannot store a 4-character tag name — that is the length of a frame id. Use a longer one.",
    tag_cover: "Cover",
    tag_cover_replace: "Replace…",
    tag_cover_remove: "Remove",
    tag_cover_will_remove: "The cover will be removed on save.",
    tag_cover_album_hint: "Written into every file of the album.",
    tag_cover_failed_title: "Could not use that image",
    ...
    tags_save_failed_t: "Failed to write tags: {}",
};
