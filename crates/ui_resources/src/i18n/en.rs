...
pub static EN: Strings = lang! {
    ...
    subsonic_url: "Server address",
    subsonic_username: "Username",
    subsonic_password: "Password",
    subsonic_connect: "Connect",
    subsonic_sync: "Sync",
    subsonic_import_stars: "Import favorites",
    network_cache: "Network cache",
    network_cache_desc: "Tracks from network sources saved for playback.",
    cache_used: "In use",
    cache_clear: "Clear",
    cache_limit: "Limit",
    ...
    size_mb_t: "{} MB",
    size_gb_t: "{} GB",
    subsonic_auth_failed: "Wrong username or password",
    subsonic_unreachable_t: "Server unreachable: {}",
    subsonic_fill_fields: "Fill in the address and username",
