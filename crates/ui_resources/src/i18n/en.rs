...
pub static EN: Strings = lang! {
    ...
    subsonic_servers_desc: "Navidrome, Gonic, Airsonic and other Subsonic-compatible servers.",
    ...
    album_to_local: "Move to local library",
    album_to_local_progress_t: "Moving to the library: {} of {} · click to stop",
    album_to_local_done_t: "Album moved to {}",
    album_to_local_failed_t: "Not everything was moved: {}",
    album_to_local_pick_title: "Move the album to",
    cache_used: "In use",
    cache_clear: "Clear",
    cache_limit: "Limit",
    ...
    torrent_upload_desc: "Pawse shares only while it downloads from a torrent, and for 15 minutes after.",
