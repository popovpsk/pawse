...
pub static ZH: Strings = lang! {
    ...
    library_folder_unavailable_t: "文件夹不可用：{}。在它恢复之前，其中的曲目将被隐藏。",
    playback_failed_title: "播放失败",
    local_folders: "本地文件夹",
    server_list: "服务器",
    subsonic_servers_desc: "Navidrome、Gonic、Airsonic 等兼容 Subsonic 的服务器。本地文件夹中也有的曲目只显示一次。",
    jellyfin_servers_desc: "Jellyfin 服务器。只需登录一次——Pawse 保存的是访问令牌，而不是密码。本地也有的曲目只显示一次。",
    server_url: "服务器地址",
    server_username: "用户名",
    server_password: "密码",
    server_connect: "连接",
    ...
    network_cache: "网络缓存",
    network_cache_desc: "来自网络的音乐会保存在磁盘上：播放过的曲目无需下载即可立即开始，离线也能播放。",
    cache_fill: "保存到缓存",
    cache_fill_progress_t: "已保存 {} / {} · 点击停止",
    cache_fill_too_big_title: "缓存放不下全部内容",
    cache_fill_too_big_t: "需要 {}，但缓存上限为 {}。只会保存前 {} 个文件（共 {} 个）。",
    cache_fill_part: "保存能放下的部分",
    cache_used: "已用",
    cache_clear: "清除",
    cache_limit: "上限",
    cache_limit_desc: "缓存超过上限时会删除最旧的曲目。",
    cache_unlimited: "不限",
    decimal_separator: ".",
    size_mb_t: "{} MB",
    size_gb_t: "{} GB",
    ...
    no_servers_added: "未添加服务器",
    torrents: "种子",
    torrent_list: "来源",
    torrents_desc: "通过 BitTorrent 共享的专辑。Pawse 只下载标签和封面来建立曲库，播放时才获取曲目。",
    torrent_magnet: "磁力链接",
    torrent_add: "添加",
    torrent_choose_file: "选择 .torrent 文件…",
    torrent_invalid: "不是磁力链接或 .torrent 文件",
    no_torrents_added: "未添加种子",
    torrent_upload: "上传",
    torrent_upload_desc: "上传可以加快下载。Pawse 只在从种子下载期间及之后 15 分钟内上传。",
    torrent_upload_while_active: "下载期间",
    torrent_upload_limited: "最高 128 KB/s",
    torrent_upload_off: "关闭",
    torrent_peers_t: "节点：{}/{}",
    server_online: "可用",
    server_offline: "不可用",
    source_syncing: "正在同步…",
    ...
    source_online: "可用",
    source_offline: "不可用",
    source_scanning: "正在扫描…",
    unavailable_count_t: "不可用：{}",
    no_music_sources: "尚未添加音乐。",
    open_library_settings: "音乐库设置",
