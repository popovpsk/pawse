...
pub static ZH: Strings = lang! {
    ...
    local_folders: "本地文件夹",
    subsonic_servers_desc: "Navidrome、Gonic、Airsonic 等兼容 Subsonic 的服务器。",
    server_url: "服务器地址",
    server_username: "用户名",
    server_password: "密码",
    server_connect: "连接",
    ...
    album_to_local: "移到本地曲库",
    album_to_local_progress_t: "正在移动：{} / {} · 点击停止",
    album_to_local_done_t: "专辑已移到 {}",
    album_to_local_failed_t: "未能全部移动：{}",
    album_to_local_pick_title: "将专辑移到",
    cache_used: "已用",
    cache_clear: "清除",
    cache_limit: "上限",
    ...
    torrent_upload: "上传",
    torrent_upload_desc: "Pawse 只在从种子下载期间及之后 15 分钟内上传。",
