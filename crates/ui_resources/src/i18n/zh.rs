...
pub static ZH: Strings = lang! {
    ...
    local_folders: "本地文件夹",
    subsonic_servers: "服务器",
    subsonic_servers_desc: "Navidrome、Gonic、Airsonic 等兼容 Subsonic 的服务器。本地文件夹中也有的曲目只显示一次。",
    subsonic_url: "服务器地址",
    subsonic_username: "用户名",
    subsonic_password: "密码",
    subsonic_connect: "连接",
    subsonic_sync: "同步",
    subsonic_import_stars: "导入收藏",
    network_cache: "网络缓存",
    network_cache_desc: "为播放而保存的网络来源曲目。",
    cache_used: "已用",
    cache_clear: "清除",
    cache_limit: "上限",
    ...
    size_mb_t: "{} MB",
    size_gb_t: "{} GB",
    subsonic_auth_failed: "用户名或密码错误",
    subsonic_unreachable_t: "无法连接服务器：{}",
    subsonic_fill_fields: "请填写地址和用户名",
