...
pub static ZH: Strings = lang! {
    ...
    lastfm_status_awaiting: "在浏览器中授权 pawse，然后确认。",
    ...
    scrobble_auth_restart: "重新打开",
    scrobble_auth_pending: "尚未授权。请在浏览器页面中允许 pawse，然后点击“确认”。如果你关闭了该页面，请点击“重新打开”。",
    scrobble_auth_link_expired: "授权链接已失效。请点击“重新打开”获取新链接。",
