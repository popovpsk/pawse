...
pub static HI: Strings = lang! {
    ...
    subsonic_url: "सर्वर का पता",
    subsonic_username: "उपयोगकर्ता नाम",
    subsonic_password: "पासवर्ड",
    subsonic_connect: "कनेक्ट करें",
    subsonic_sync: "सिंक करें",
    subsonic_import_stars: "पसंदीदा आयात करें",
    network_cache: "नेटवर्क कैश",
    network_cache_desc: "चलाने के लिए सहेजे गए नेटवर्क स्रोतों के ट्रैक।",
    ...
    size_mb_t: "{} MB",
    size_gb_t: "{} GB",
    subsonic_auth_failed: "गलत उपयोगकर्ता नाम या पासवर्ड",
    subsonic_unreachable_t: "सर्वर तक पहुँच नहीं: {}",
    subsonic_fill_fields: "पता और उपयोगकर्ता नाम भरें",
