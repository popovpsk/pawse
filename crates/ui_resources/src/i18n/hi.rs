...
pub static HI: Strings = lang! {
    ...
    subsonic_synced_t: "सर्वर पर ट्रैक: {}, स्थानीय से मेल खाए: {}",
    ...
    remove_server_confirm_message: "इसके ट्रैक लाइब्रेरी से हट जाएँगे। पसंद और प्लेलिस्ट उन्हें रखेंगी, और सर्वर दोबारा जोड़ने पर वे लौट आएँगे।",
