...
pub static HI: Strings = lang! {
    ...
    subsonic_servers_desc: "Navidrome, Gonic, Airsonic और अन्य Subsonic-संगत सर्वर।",
    ...
    album_to_local: "लोकल लाइब्रेरी में ले जाएँ",
    album_to_local_progress_t: "ले जाया जा रहा है: {} / {} · रोकने के लिए क्लिक करें",
    album_to_local_done_t: "एल्बम {} में ले जाया गया",
    album_to_local_failed_t: "सब कुछ नहीं ले जाया जा सका: {}",
    album_to_local_pick_title: "एल्बम यहाँ ले जाएँ",
    ...
    torrent_upload_desc: "Pawse केवल टोरेंट से डाउनलोड करते समय और उसके 15 मिनट बाद तक साझा करता है।",
