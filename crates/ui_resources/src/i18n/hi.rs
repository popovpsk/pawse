...
pub static HI: Strings = lang! {
    ...
    scrobble_auth_restart: "फिर से खोलें",
    scrobble_auth_pending: "अभी अधिकृत नहीं है। ब्राउज़र के पेज पर pawse को अनुमति दें, फिर पुष्टि करें दबाएँ। यदि वह पेज बंद कर दिया है, तो फिर से खोलें दबाएँ।",
    scrobble_auth_link_expired: "अधिकृत करने का लिंक अब मान्य नहीं है। नया पाने के लिए फिर से खोलें दबाएँ।",
