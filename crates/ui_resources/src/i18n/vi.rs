...
pub static VI: Strings = lang! {
    ...
    subsonic_synced_t: "Bài trên máy chủ: {}, khớp với cục bộ: {}",
    ...
    remove_server_confirm_message: "Các bài hát của máy chủ này biến khỏi thư viện. Lượt thích và danh sách phát vẫn giữ chúng, và chúng quay lại nếu bạn thêm máy chủ lần nữa.",
