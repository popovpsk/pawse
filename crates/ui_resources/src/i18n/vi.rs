...
pub static VI: Strings = lang! {
    ...
    subsonic_url: "Địa chỉ máy chủ",
    subsonic_username: "Tên người dùng",
    subsonic_password: "Mật khẩu",
    subsonic_connect: "Kết nối",
    subsonic_sync: "Đồng bộ",
    subsonic_import_stars: "Nhập mục yêu thích",
    network_cache: "Bộ nhớ đệm mạng",
    network_cache_desc: "Bài hát từ nguồn mạng được lưu để phát.",
    cache_used: "Đã dùng",
    ...
    size_mb_t: "{} MB",
    size_gb_t: "{} GB",
    subsonic_auth_failed: "Sai tên người dùng hoặc mật khẩu",
    subsonic_unreachable_t: "Không kết nối được máy chủ: {}",
    subsonic_fill_fields: "Nhập địa chỉ và tên người dùng",
