...
pub static VI: Strings = lang! {
    ...
    subsonic_servers_desc: "Navidrome, Gonic, Airsonic và các máy chủ tương thích Subsonic khác.",
    ...
    album_to_local: "Chuyển vào thư viện cục bộ",
    album_to_local_progress_t: "Đang chuyển: {} / {} · nhấn để dừng",
    album_to_local_done_t: "Đã chuyển album tới {}",
    album_to_local_failed_t: "Chưa chuyển được hết: {}",
    album_to_local_pick_title: "Chuyển album tới",
    cache_used: "Đã dùng",
    ...
    torrent_upload_desc: "Pawse chỉ chia sẻ khi đang tải từ torrent và thêm 15 phút sau đó.",
