...
pub static VI: Strings = lang! {
    ...
    scrobble_auth_restart: "Mở lại",
    scrobble_auth_pending: "Chưa được cấp quyền. Hãy chấp nhận pawse trên trang trong trình duyệt rồi nhấn Xác nhận. Nếu bạn đã đóng trang đó, hãy nhấn Mở lại.",
    scrobble_auth_link_expired: "Liên kết cấp quyền không còn hiệu lực. Nhấn Mở lại để lấy liên kết mới.",
