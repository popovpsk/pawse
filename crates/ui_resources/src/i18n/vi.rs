...
pub static VI: Strings = lang! {
    ...
    local_folders: "Thư mục cục bộ",
    server_list: "Máy chủ",
    subsonic_servers_desc: "Navidrome, Gonic, Airsonic và các máy chủ tương thích Subsonic khác. Bài hát cũng có trong thư mục cục bộ chỉ hiện một lần.",
    jellyfin_servers_desc: "Máy chủ Jellyfin. Đăng nhập một lần — Pawse lưu mã truy cập, không lưu mật khẩu của bạn. Các bản nhạc cũng có trên máy chỉ hiển thị một lần.",
    server_url: "Địa chỉ máy chủ",
    server_username: "Tên người dùng",
    server_password: "Mật khẩu",
    server_connect: "Kết nối",
    server_sync: "Đồng bộ",
    server_import_favorites: "Nhập mục yêu thích",
    network_cache: "Bộ nhớ đệm mạng",
    network_cache_desc: "Nhạc từ mạng được lưu trên ổ đĩa: bài đã nghe sẽ phát ngay, không cần tải lại, và phát được cả khi không có mạng.",
    ...
    cache_fill_too_big_t: "Cần {} nhưng giới hạn bộ nhớ đệm là {}. Chỉ {} trong {} tệp đầu tiên được lưu.",
    cache_fill_part: "Lưu phần vừa đủ",
    cache_used: "Đã dùng",
    cache_clear: "Dọn sạch",
    cache_limit: "Giới hạn",
    cache_limit_desc: "Khi vượt giới hạn, các bài cũ nhất bị xóa.",
    cache_unlimited: "Không giới hạn",
    decimal_separator: ",",
    size_mb_t: "{} MB",
    size_gb_t: "{} GB",
    ...
    no_servers_added: "Chưa thêm máy chủ",
    torrents: "Torrent",
    torrent_list: "Nguồn",
    torrents_desc: "Album chia sẻ qua BitTorrent. Pawse chỉ tải thẻ và ảnh bìa để tạo thư viện, và tải bài hát khi bạn phát.",
    torrent_magnet: "Liên kết magnet",
    torrent_add: "Thêm",
    torrent_choose_file: "Chọn tệp .torrent…",
    torrent_invalid: "Không phải liên kết magnet hay tệp .torrent",
    no_torrents_added: "Chưa thêm torrent nào",
    torrent_upload: "Tải lên",
    torrent_upload_desc: "Chia sẻ giúp tải nhanh hơn. Pawse chỉ chia sẻ khi đang tải từ torrent và thêm 15 phút sau đó.",
    torrent_upload_while_active: "Khi đang tải",
    torrent_upload_limited: "Tối đa 128 KB/s",
    torrent_upload_off: "Tắt",
    ...
    source_scanning: "Đang quét…",
    unavailable_count_t: "Không khả dụng: {}",
    no_music_sources: "Chưa thêm nhạc nào.",
    open_library_settings: "Cài đặt thư viện",
    ...
    settings_now_playing: "Đang phát",
    now_playing_details: "Dòng thứ ba",
    now_playing_details_desc: "Hiển thị gì bên dưới tên bài hát và nghệ sĩ",
    now_playing_details_specs: "Định dạng",
    ...
    blur_background_desc: "Dùng ảnh bìa đã làm mờ làm nền",
    blur_background_off: "Tắt",
    blur_background_cover: "Chế độ bìa",
    blur_background_all: "Mọi màn hình",
    blur_intensity: "Cường độ làm mờ",
    blur_intensity_desc: "Nền mờ đến mức nào",
    blur_interface_opacity: "Độ mờ đục giao diện",
    blur_interface_opacity_desc: "Giao diện trong suốt thế nào trên nền mờ",
    ...
    albums_layout: "Bố cục",
    albums_layout_desc: "Cách hiển thị album trong tab Album",
    albums_layout_list: "Danh sách",
    albums_layout_grid: "Lưới",
    year_column: "Cột năm",
    year_column_desc: "Hiển thị cột năm trong danh sách album",
    album_year: "Năm",
    album_year_desc: "Hiển thị năm trong chú thích ô",
    ...
    scrobble_account: "Tài khoản",
    scrobble_enabled: "Bật",
    scrobble_send_loves: "Gửi lượt thích",
    scrobble_send_loves_desc: "Thích ở đây cũng thêm bài hát vào yêu thích trên dịch vụ. Bỏ thích sẽ xoá khỏi đó.",
    scrobble_file: "Tệp",
    scrobble_first_artist: "Chỉ scrobble nghệ sĩ đầu tiên",
    scrobble_first_artist_desc: "Gửi một tên nghệ sĩ cho mỗi bài thay vì ghép tất cả người trình bày.",
    scrobble_csv: "Nhật ký CSV",
    scrobble_csv_desc: "Ghi mỗi scrobble vào một tệp CSV cục bộ.",
    scrobble_file_open: "Mở…",
    scrobble_file_new: "Tạo mới…",
    scrobble_not_a_log: "Tệp này không phải nhật ký scrobble của pawse.",
    scrobble_token: "Mã thông báo",
    scrobble_server: "Máy chủ",
    scrobble_connect: "Kết nối",
    scrobble_auth_expired: "Ủy quyền đã hết hạn, hãy đăng nhập lại",
    scrobble_auth_cancel: "Hủy",
    scrobble_auth_link_expired: "Liên kết cấp quyền không còn hiệu lực. Hãy đăng nhập lại để lấy liên kết mới.",
    scrobble_import_loves: "Nhập bài hát yêu thích",
    scrobble_import_loves_desc: "Những gì được đánh dấu trong hồ sơ sẽ vào «Bài yêu thích». Không gửi ngược lại gì cả.",
    scrobble_import_run: "Nhập",
    scrobble_import_result_t: "Tìm thấy trong thư viện: {}/{}",
    scrobble_importing: "Đang nhập…",
