...
pub static SV: Strings = lang! {
    ...
    subsonic_synced_t: "Spår på servern: {}, matchade med lokala: {}",
    ...
    remove_server_confirm_message: "Dess spår försvinner ur biblioteket. Gillade och spellistor behåller dem, och de kommer tillbaka om du lägger till servern igen.",
