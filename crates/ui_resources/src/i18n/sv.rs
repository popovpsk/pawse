...
pub static SV: Strings = lang! {
    ...
    local_folders: "Lokala mappar",
    server_list: "Servrar",
    subsonic_servers_desc: "Navidrome, Gonic, Airsonic och andra Subsonic-kompatibla servrar. Spår som också finns i lokala mappar visas en gång.",
    jellyfin_servers_desc: "Jellyfin-servrar. Logga in en gång – Pawse sparar en åtkomsttoken, inte ditt lösenord. Spår som du även har lokalt visas en gång.",
    ...
    network_cache_desc: "Musik från nätet sparas på disken: ett spår du redan spelat startar direkt, utan nedladdning, och spelas även offline.",
    ...
    cache_fill_too_big_t: "Det behövs {}, men cachegränsen är {}. Bara de första {} av {} filerna sparas.",
    cache_fill_part: "Spara det som får plats",
    cache_used: "Används",
    cache_clear: "Rensa",
    cache_limit: "Gräns",
    cache_limit_desc: "När cachen går över gränsen tas de äldsta spåren bort.",
    cache_unlimited: "Obegränsat",
    decimal_separator: ",",
    size_mb_t: "{} MB",
    size_gb_t: "{} GB",
    ...
    no_servers_added: "Inga servrar tillagda",
    torrents: "Torrenter",
    torrent_list: "Källor",
    torrents_desc: "Album som delas via BitTorrent. Pawse hämtar bara taggar och omslag till biblioteket och hämtar ett spår när du spelar det.",
    torrent_magnet: "Magnetlänk",
    torrent_add: "Lägg till",
    torrent_choose_file: "Välj .torrent-fil…",
    torrent_invalid: "Inte en magnetlänk eller .torrent-fil",
    no_torrents_added: "Inga torrenter tillagda",
    torrent_upload: "Uppladdning",
    torrent_upload_desc: "Att dela snabbar upp nedladdningen. Pawse delar bara medan det laddar ner från en torrent, och 15 minuter efter.",
    torrent_upload_while_active: "Under nedladdning",
    torrent_upload_limited: "Upp till 128 KB/s",
    torrent_upload_off: "Av",
    ...
    source_scanning: "Skannar…",
    unavailable_count_t: "Inte tillgängliga: {}",
    no_music_sources: "Ingen musik har lagts till än.",
    open_library_settings: "Biblioteksinställningar",
    ...
    settings_now_playing: "Spelas nu",
    now_playing_details: "Tredje raden",
    now_playing_details_desc: "Vad som visas under titeln och artisten",
    ...
    blur_background: "Suddig bakgrund",
    blur_background_desc: "Använd det suddiga omslaget som bakgrund",
    blur_background_off: "Av",
    blur_background_cover: "Omslagsvy",
    blur_background_all: "Alla vyer",
    blur_intensity: "Suddighetsintensitet",
    blur_intensity_desc: "Hur suddig bakgrunden är",
    blur_interface_opacity: "Gränssnittets opacitet",
    blur_interface_opacity_desc: "Hur genomskinligt gränssnittet är över oskärpan",
    ...
    albums_layout_desc: "Hur album visas på fliken Album",
    albums_layout_list: "Lista",
    albums_layout_grid: "Rutnät",
    year_column: "Årskolumn",
    year_column_desc: "Visa årskolumnen i albumlistan",
    album_year: "År",
    album_year_desc: "Visa året i rutans bildtext",
    ...
    native_rate_title: "Native samplingsfrekvens",
    ...
    scrobble_enabled: "Aktiverad",
    scrobble_send_loves: "Skicka gillningar",
    scrobble_send_loves_desc: "Att gilla här lägger även till låten som favorit hos tjänsten. Att ta bort raderar den där också.",
    scrobble_file: "Fil",
    scrobble_first_artist: "Scrobbla bara första artisten",
    scrobble_first_artist_desc: "Skicka ett artistnamn per låt i stället för att slå ihop alla medverkande.",
    scrobble_csv: "CSV-logg",
    scrobble_csv_desc: "Lägg till varje scrobble i en lokal CSV-fil.",
    scrobble_file_open: "Öppna…",
    scrobble_file_new: "Ny…",
    scrobble_not_a_log: "Den filen är ingen pawse-scrobbellogg.",
    scrobble_token: "Token",
    scrobble_server: "Server",
    scrobble_connect: "Anslut",
    scrobble_auth_expired: "Behörigheten har gått ut, logga in igen",
    scrobble_auth_cancel: "Avbryt",
    scrobble_auth_link_expired: "Auktoriseringslänken gäller inte längre. Logga in igen för att få en ny.",
    scrobble_import_loves: "Importera gillade låtar",
    scrobble_import_loves_desc: "Det som är markerat i profilen hamnar under «Gillade låtar». Inget skickas tillbaka.",
    scrobble_import_run: "Importera",
    scrobble_import_result_t: "Hittade i biblioteket: {} av {}",
    scrobble_importing: "Importerar…",
    ...
    native_rate_failed_t: "Kunde inte slå på native samplingsfrekvens: {}",
