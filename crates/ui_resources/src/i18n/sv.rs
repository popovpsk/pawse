...
pub static SV: Strings = lang! {
    ...
    subsonic_servers_desc: "Navidrome, Gonic, Airsonic och andra Subsonic-kompatibla servrar.",
    ...
    album_to_local: "Flytta till lokalt bibliotek",
    album_to_local_progress_t: "Flyttar: {} av {} · klicka för att stoppa",
    album_to_local_done_t: "Albumet flyttat till {}",
    album_to_local_failed_t: "Allt flyttades inte: {}",
    album_to_local_pick_title: "Flytta albumet till",
    cache_used: "Används",
    cache_clear: "Rensa",
    cache_limit: "Gräns",
    ...
    torrent_upload_desc: "Pawse delar bara medan det laddar ner från en torrent, och 15 minuter efter.",
