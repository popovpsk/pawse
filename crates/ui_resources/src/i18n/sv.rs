...
pub static SV: Strings = lang! {
    ...
    scrobble_auth_restart: "Öppna igen",
    scrobble_auth_pending: "Inte auktoriserad än. Godkänn pawse på sidan i webbläsaren och tryck sedan på Bekräfta. Om du stängde sidan, tryck på Öppna igen.",
    scrobble_auth_link_expired: "Auktoriseringslänken gäller inte längre. Tryck på Öppna igen för att få en ny.",
