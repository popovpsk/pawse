...
pub static SV: Strings = lang! {
    ...
    subsonic_url: "Serveradress",
    subsonic_username: "Användarnamn",
    subsonic_password: "Lösenord",
    subsonic_connect: "Anslut",
    subsonic_sync: "Synkronisera",
    subsonic_import_stars: "Importera favoriter",
    network_cache: "Nätverkscache",
    network_cache_desc: "Spår från nätverkskällor som sparats för uppspelning.",
    cache_used: "Används",
    cache_clear: "Rensa",
    cache_limit: "Gräns",
    ...
    size_mb_t: "{} MB",
    size_gb_t: "{} GB",
    subsonic_auth_failed: "Fel användarnamn eller lösenord",
    subsonic_unreachable_t: "Servern kan inte nås: {}",
    subsonic_fill_fields: "Fyll i adress och användarnamn",
