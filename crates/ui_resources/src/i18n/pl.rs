...
pub static PL: Strings = lang! {
    ...
    subsonic_url: "Adres serwera",
    subsonic_username: "Nazwa użytkownika",
    subsonic_password: "Hasło",
    subsonic_connect: "Połącz",
    subsonic_sync: "Synchronizuj",
    subsonic_import_stars: "Importuj ulubione",
    subsonic_auth_failed: "Błędna nazwa użytkownika lub hasło",
    subsonic_unreachable_t: "Serwer niedostępny: {}",
    subsonic_synced_t: "Utworów na serwerze: {}, dopasowanych do lokalnych: {}",
    subsonic_fill_fields: "Uzupełnij adres i nazwę użytkownika",
    ...
    remove_server_confirm_message: "Jego utwory znikną z biblioteki. Polubienia i playlisty je zachowają, a wrócą, gdy ponownie dodasz serwer.",
