...
pub static PL: Strings = lang! {
    ...
    subsonic_servers_desc: "Navidrome, Gonic, Airsonic i inne serwery zgodne z Subsonic.",
    ...
    album_to_local: "Przenieś do lokalnej biblioteki",
    album_to_local_progress_t: "Przenoszenie: {} z {} · kliknij, aby zatrzymać",
    album_to_local_done_t: "Album przeniesiono do {}",
    album_to_local_failed_t: "Nie wszystko zostało przeniesione: {}",
    album_to_local_pick_title: "Przenieś album do",
    cache_used: "Zajęte",
    cache_clear: "Wyczyść",
    cache_limit: "Limit",
    ...
    torrent_upload_desc: "Pawse udostępnia tylko podczas pobierania z torrenta i przez 15 minut potem.",
