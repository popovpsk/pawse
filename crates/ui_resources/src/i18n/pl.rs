...
pub static PL: Strings = lang! {
    ...
    scrobble_auth_restart: "Otwórz ponownie",
    scrobble_auth_pending: "Jeszcze nie autoryzowano. Zatwierdź pawse na stronie w przeglądarce, a następnie naciśnij „Potwierdź”. Jeśli zamknąłeś tę stronę, naciśnij „Otwórz ponownie”.",
    scrobble_auth_link_expired: "Link autoryzacyjny wygasł. Naciśnij „Otwórz ponownie”, aby uzyskać nowy.",
