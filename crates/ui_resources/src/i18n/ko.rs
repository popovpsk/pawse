...
pub static KO: Strings = lang! {
    ...
    local_folders: "로컬 폴더",
    subsonic_servers_desc: "Navidrome, Gonic, Airsonic 등 Subsonic 호환 서버.",
    server_url: "서버 주소",
    ...
    album_to_local: "로컬 라이브러리로 이동",
    album_to_local_progress_t: "이동 중: {} / {} · 클릭하면 중지",
    album_to_local_done_t: "앨범을 {}(으)로 이동했습니다",
    album_to_local_failed_t: "일부를 이동하지 못했습니다: {}",
    album_to_local_pick_title: "앨범 이동 위치",
    cache_used: "사용 중",
    cache_clear: "지우기",
    cache_limit: "한도",
    ...
    torrent_upload: "업로드",
    torrent_upload_desc: "Pawse는 토렌트에서 다운로드하는 동안과 그 후 15분 동안만 공유합니다.",
