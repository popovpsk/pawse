...
pub static KO: Strings = lang! {
    ...
    scrobble_auth_restart: "다시 열기",
    scrobble_auth_pending: "아직 승인되지 않았습니다. 브라우저 페이지에서 pawse를 승인한 뒤 확인을 누르세요. 해당 페이지를 닫았다면 다시 열기를 누르세요.",
    scrobble_auth_link_expired: "인증 링크가 만료되었습니다. 다시 열기를 눌러 새 링크를 받으세요.",
