...
pub static KO: Strings = lang! {
    ...
    subsonic_url: "서버 주소",
    subsonic_username: "사용자 이름",
    subsonic_password: "비밀번호",
    subsonic_connect: "연결",
    subsonic_sync: "동기화",
    subsonic_import_stars: "즐겨찾기 가져오기",
    subsonic_auth_failed: "사용자 이름 또는 비밀번호가 올바르지 않습니다",
    subsonic_unreachable_t: "서버에 연결할 수 없습니다: {}",
    subsonic_synced_t: "서버의 트랙: {}, 로컬과 일치: {}",
    subsonic_fill_fields: "주소와 사용자 이름을 입력하세요",
    no_servers_added: "추가된 서버가 없습니다",
    server_online: "사용 가능",
    server_offline: "사용 불가",
    source_syncing: "동기화 중…",
    remove_server_confirm_title: "서버를 제거할까요?",
    remove_server_confirm_message: "이 서버의 트랙이 라이브러리에서 사라집니다. 좋아요와 재생목록에는 남아 있으며, 서버를 다시 추가하면 돌아옵니다.",
    source_online: "사용 가능",
